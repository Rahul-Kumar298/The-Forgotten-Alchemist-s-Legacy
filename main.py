...
print()
print()
overveiw = """"The Forgotten Alchemist’s Legacy" is a text-based adventure game where players explore the abandoned tower of Professor Thaddeus Evergreen, a legendary alchemist. The game is filled with puzzles, ethical dilemmas, and multiple endings based on player cs."""
print(overveiw)
...
if c1 == "y":
    ...
    if c2 == 1:
        ...
        from fire_chamber import play_flame_symbol_puzzle
        task_completed = 0
        print()
